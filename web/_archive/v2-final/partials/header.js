...
document.write([
  ...
  '    </nav>',
  '    <button class="mobile-toggle" aria-expanded="false" aria-label="Menu"><span></span><span></span><span></span></button>',
  '    <nav id="mobile-nav" aria-hidden="true">',
  '      <a href="index.html" data-nav="index.html">Rozwiązania</a>',
  '      <a href="technology.html" data-nav="technology.html">Technologia</a>',
  '      <a href="kalkulator-roi.html" data-nav="kalkulator-roi.html">Kalkulator</a>',
  '      <a href="#contact" class="btn btn-primary">Zdobądź ocenę</a>',
  '    </nav>',
  '  </div>',
  '</header>'
].join(''));
