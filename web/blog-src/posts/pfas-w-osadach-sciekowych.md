---
title: "PFAS w osadach ściekowych — jak oczyszczalnia nieświadomie zatruwa glebę"
heroTitle: "PFAS w osadach<br><span class='t-accent'>niewidzialne</span><br>zagrożenie"
description: "PFAS koncentrują się w osadzie 10–1000× vs ścieki. UWWTD wymusza monitoring od 2027. HTC usuwa >96% PFCAs. Porównanie metod i plan działania dla oczyszczalni."
keywords: "PFAS osady ściekowe, wieczne chemikalia oczyszczalnia, PFAS monitoring UWWTD, HTC usuwanie PFAS, osad ściekowy PFAS Polska"
date: 2026-07-03
readTime: "12"
author: "Dr hab. inż. Małgorzata Wilk"
heroImage: "/v5/assets/img/laboratory.jpeg"
tags:
  - PFAS
  - osady ściekowe
  - UWWTD
  - HTC
faq:
  - q: "Czy HTC całkowicie usuwa PFAS z osadu ściekowego?"
    a: "Dla PFCAs (kwasów perfluorokarboksylowych) — tak, skuteczność >96%. Dla PFSAs (kwasów perfluorosulfonowych, np. PFOS) standardowy HTC jest mniej skuteczny — może wymagać modyfikacji alkalicznej (HALT). Wynik zależy od składu PFAS w osadzie, który określa analiza TEO."
  - q: "Kiedy monitoring PFAS w osadach stanie się obowiązkowy w Polsce?"
    a: "UWWTD 2024/3019 nakłada obowiązek monitoringu PFAS od razu na oczyszczalnie >100 000 RLM, z rozszerzeniem na mniejsze. Polska musi transponować dyrektywę do 31.07.2027 — od tego momentu wyniki monitoringu staną się wiążącymi faktami prawnymi."
  - q: "Ile kosztuje instalacja HTC i czy są dotacje na usuwanie PFAS?"
    a: "Orientacyjnie PLN 18–30 mln dla oczyszczalni 15 000–25 000 RLM. FENX.01.03 pokrywa do 70% CapEx (termin: 31.12.2029). Przy łączonym dofinansowaniu NFOŚiGW wkład gminy spada do 15–30%."
  - q: "Czy spalanie nie jest lepszym sposobem na PFAS niż HTC?"
    a: "Spalanie przy >850°C niszczy >90% PFAS, ale w Polsce jest potencjał tylko na 23% osadu (11 spalarni), a cena to 500–800 PLN/t. HTC kosztuje 180–250 PLN/t i jest dostępne od zaraz."
  - q: "Nasza gmina wywozi osad na pola — jaki jest realny risk?"
...
[Dyrektywa UWWTD 2024/3019](/v5/blog/uwwtd-osady-sciekowe/) (obowiązuje od 01.01.2025) wprowadza obowiązkowy monitoring PFAS w osadzie dla wszystkich oczyszczalni powyżej 100 000 RLM, z rozszerzeniem na mniejsze. Transpozycja w Polsce: termin 31.07.2027.
...
<div class="blog-cta">
  <strong>Jaki jest poziom PFAS w Twoim osadzie?</strong><br>
  Analiza TEO obejmuje pełne badanie składu chemicznego osadu, w tym PFAS. <a href="/v5/dotacje.html">Dofinansowanie pokrywa do 90% kosztów</a>.<br>
  <a href="/v5/teo.html" class="btn btn-primary">Dowiedz się o TEO →</a>
</div>
...
Dla oczyszczalni poniżej 15 000 RLM ekonomika zmienia się przez [Hub & Spoke](/v5/hub-spoke.html).

<div class="blog-cta">
  <strong>Porównaj koszty dla Twojej oczyszczalni</strong><br>
  Kalkulator ROI uwzględnia obecny koszt utylizacji, dotacje i wariant HTC.<br>
  <a href="/v5/kalkulator-roi.html" class="btn btn-primary">Oblicz ROI →</a>
</div>
...
**Po pierwsze: przygotowanie do [dotacji](/v5/dotacje.html) wymaga czasu.** FENX.01.03 (EUR 1,05 mld, do 70% CapEx) wymaga analizy [TEO](/v5/teo.html) jako warunku formalnego wniosku. TEO trwa 6 tygodni. Potem projektowanie, uzgodnienia, przetarg — 18–24 miesiące. Termin FENX: 31.12.2029. Jeśli zacząć w 2027 — czasu już nie ma.
...
Pierwszy krok — nie wybór technologii. To **[analiza TEO](/v5/teo.html)** dla Twojej oczyszczalni.

TEO odpowiada na pytania: jakie stężenia PFAS w Twoim osadzie, jaka optymalna konfiguracja HTC dla Twojego wolumenu, jaka ekonomika projektu, jaka ścieżka [dotacyjna](/v5/dotacje.html). Bez tego dokumentu rozmowa o technologii pozostaje abstrakcyjna. Z nim masz konkretne liczby — dla rady, dla wniosku grantowego, dla przetargu.
...
Niszczy >90% PFAS przy >850°C, ale potencjał tylko 23% osadu krajowego, cena 500–800 PLN/t. [HTC](/v5/technologia.html): 180–250 PLN/t i dostępne od zaraz.

**Nasza gmina wywozi osad na pola — co nam grozi?**

Po wprowadzeniu monitoringu UWWTD (2027+) przekroczenia PFAS = blokada stosowania rolniczego przez WIOŚ. Bez czasu na przygotowanie alternatywy. [Sprawdź referencje →](/v5/case-lubin.html)
...
- [Rozporządzenie MŚ z dn. 6.02.2015 ws. komunalnych osadów ściekowych](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20150000257) — ISAP
- [ECHA — propozycja ograniczenia PFAS (REACH)](https://echa.europa.eu/registry-of-restriction-intentions/-/registry-of-restriction-intentions/q?p_p_id=disrestrictionintentions_WAR) — ECHA
...
- Dane własne BTC Consulting / AGH Kraków (dane niepublikowane, dostępne na życzenie)

*Materiał przygotowany przez Dr hab. inż. Małgorzatę Wilk (AGH Kraków / BTC Consulting) na podstawie zweryfikowanych danych badawczych. Konkretne parametry PFAS zależą od charakterystyk osadu i określane są w ramach analizy TEO. Nie stanowi porady prawnej.*
