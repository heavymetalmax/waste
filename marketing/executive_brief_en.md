...
```mermaid
graph LR
    Input[1. Wet Feedstock <br> 80% Moisture] --> Process(2. Molecular Reactor <br> 200°C / 20 Bar)
    Process --> Dehydration[3. Mechanical Press <br> Moisture drops to 30%]
    Dehydration --> Output1[4a. Eco-Coal <br> Solid biofuel]
    Dehydration --> Output2[4b. Clean Water <br> Recycled output]

    style Process fill:#f8fafc,stroke:#d35400,stroke-width:2px;
    style Output1 fill:#f0fdf4,stroke:#0d9488,stroke-width:2px;
    style Output2 fill:#ecf5ff,stroke:#007bff,stroke-width:2px;
```
